...
void ABoidComponent::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	for (int i = 0; i < FlockActorPoolThreadArr.Num(); i++)
	{
...
void ABoidComponent::BeginDestroy()
{
	for (int i = 0; i < FlockActorPoolThreadArr.Num(); i++)
	{
		if (FlockActorPoolThreadArr[i])
...
void ABoidComponent::GenerateFlockThread()
{
...
void ABoidComponent::AddAvoidanceComponentsTimer()
{
...
void ABoidComponent::DivideFlockArrayForThreads()
{
...
void ABoidComponent::AddFlockMemberWorldSpace(const FTransform& WorldTransform)
{
